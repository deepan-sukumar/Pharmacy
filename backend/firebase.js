...
try {
  if (fs.existsSync(keyPath)) {
    ...
    console.warn('⚠️ No serviceAccountKey.json found in "server/" folder and no Firebase credentials in .env.');
    console.warn('ℹ️ To connect live Firestore: Download serviceAccountKey.json from Firebase Console > Project Settings > Service Accounts, and save it in the "server/" folder.');
  }
} catch (error) {
